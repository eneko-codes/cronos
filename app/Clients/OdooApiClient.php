...
class OdooApiClient
{
    ...
    private function call(
        ...
        try {
            ...
            Log::debug('Odoo API Response', [
                ...
                'count' => is_array($responseBody['result'] ?? null) ? count($responseBody['result']) : null,
            ]);
     ...
     * @return Collection|OdooUserDTO[] Collection of OdooUserDTOs.
     */
     ...
     *
     * @param  array  $domain  Optional domain filters.
     * @return Collection|OdooDepartmentDTO[] Collection of OdooDepartmentDTOs.
     */
     ...
     *
     * @param  array  $domain  Optional domain filters.
     * @return Collection|OdooCategoryDTO[] Collection of OdooCategoryDTOs.
     */
     ...
     *
     * @param  array  $domain  Optional domain filters.
     * @return Collection|OdooLeaveTypeDTO[] Collection of OdooLeaveTypeDTOs.
     */
     ...
     * @return Collection|OdooLeaveDTO[] Collection of OdooLeaveDTOs.
     */
     ...
     *
     * @param  array  $domain  Optional domain filters.
     * @return Collection|OdooScheduleDTO[] Collection of OdooScheduleDTOs.
     */
     ...
     *
     * @param  array  $domain  Optional domain filters.
     * @return Collection|OdooScheduleDetailDTO[] Collection of OdooScheduleDetailDTOs.
     */
