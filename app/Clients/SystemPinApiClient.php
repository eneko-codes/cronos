...
class SystemPinApiClient
{
    ...
    private function call(string $endpoint, array $params = []): array
    {
        try {
            ...
            Log::debug('SystemPin API Response', [
                ...
                'count' => is_array($response->json()) ? count($response->json()) : null,
            ]);
    ...
    public function getAllEmployees(): Collection
    {
        try {
            ...
            if (! isset($data['data']) || ! is_array($data['data'])) {
                Log::warning('SystemPin API returned unexpected employee data structure', [
    ...
    public function getAttendanceData(string $fromDate, string $toDate): Collection
    {
        try {
            ...
            if (empty($data)) {
                Log::warning('SystemPin API returned empty attendance data');
