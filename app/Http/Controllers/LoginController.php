...
class LoginController extends Controller
{
     ...
     *
     * @param  LoginRequest  $loginRequest  The validated login request containing email, password, and remember flag
     * @return RedirectResponse Redirects to dashboard on success, verification notice if email unverified, back with errors on failure
     *
     ...
     *
     * @param  Request  $httpRequest  The HTTP request instance
