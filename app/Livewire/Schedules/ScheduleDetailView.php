...
class ScheduleDetailView extends Component
{
    ...
    /**
     * Re-eager-load scheduleDetails on every Livewire request — strict mode is on and
     * default model hydration drops preloaded relations, which would break groupedScheduleDetails().
     */
    public function hydrate(): void
    {
        $this->schedule->loadMissing(['scheduleDetails']);
    }
