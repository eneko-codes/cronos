 ...
 * @property-read Collection|ScheduleDetail[] $scheduleDetails Daily time slots in this schedule
 * @property-read Collection|UserSchedule[] $userSchedules User assignments to this schedule
...
class Schedule extends Model
{
    ...
    {
        return [
            'odoo_schedule_id' => $this->odoo_schedule_id,
