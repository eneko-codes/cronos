 ...
 * @property Carbon|null $odoo_created_at Creation date of the record in Odoo
 * @property Carbon|null $odoo_updated_at Last update date of the record in Odoo
 ...
 * @property Carbon|null $date_from Optional start date for when the attendance is active
 * @property Carbon|null $date_to Optional end date for when the attendance is active
 * @property-read CarbonInterval $duration The duration between start and end times
...
class ScheduleDetail extends Model
{
    ...
    protected function duration(): Attribute
    {
        return Attribute::make(
            get: fn () => CarbonInterval::seconds($this->start->diffInSeconds($this->end))
        );
    }
    ...
    {
        return Attribute::make(
            get: fn () => DurationFormatterService::fromInterval($this->duration)
        );
    }
     ...
     */
    #[Scope]
    protected function activeForDate(Builder $query, string $date): void
    {
    ...
    /**
     * Scope a query to only include schedule details for a specific weekday.
     */
    #[Scope]
    protected function forWeekday(Builder $query, int $weekday): void
    {
        $query->where('weekday', $weekday);
    }

    /**
     * Scope a query to only include active schedule details.
     */
    #[Scope]
