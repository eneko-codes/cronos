...
class TimeEntry extends Model
{
     ...
     */
    #[Scope]
    protected function betweenDates(Builder $query, \Carbon\CarbonInterface|string $from, \Carbon\CarbonInterface|string $to): void
    {
     ...
     */
    #[Scope]
    protected function forDate(Builder $query, \Carbon\CarbonInterface|string $date): void
    {
