 ...
 * @property Carbon|null $email_verified_at When the email was verified
 ...
 * @property Carbon|null $created_at When record was created
 * @property Carbon|null $updated_at When record was last updated
 * @property bool|null $is_online Virtual attribute that determines if the user is currently online
 * @property string|null $remember_token
 * @property-read Schedule|null $activeSchedule
 * @property-read UserSchedule|null $activeUserSchedule
 * @property-read Collection<int, Category> $categories
 * @property-read int|null $categories_count
 * @property-read Department|null $department
 * @property-read Collection<int, UserExternalIdentity> $externalIdentities
 * @property-read int|null $external_identities_count
 * @property-read UserNotificationPreference $notificationPreferences
 * @property-read DatabaseNotificationCollection<int, \Illuminate\Notifications\DatabaseNotification> $notifications
 * @property-read int|null $notifications_count
 * @property-read TaskUser|ProjectUser|null $pivot
 ...
 * @property-read Collection<int, UserAttendance> $userAttendances
 * @property-read int|null $user_attendances_count
 * @property-read Collection<int, UserLeave> $userLeaves
 * @property-read int|null $user_leaves_count
 * @property-read Collection<int, UserSchedule> $userSchedules
...
class User extends Authenticatable implements CanResetPassword, MustVerifyEmail
{
    ...
    /**
     * Route Slack notifications. Returns the user's per-user channel/DM ID if set;
     * otherwise falls back to the global default channel from services.slack config.
     * Returning null skips delivery cleanly when neither is configured.
     */
    public function routeNotificationForSlack(Notification $notification): ?string
    {
        return $this->slack_channel_id ?: config('services.slack.notifications.channel');
    }
}
