 ...
 * @property Carbon $start_date Beginning of leave period
 * @property Carbon $end_date End of leave period
...
class UserLeave extends Model
{
    ...
    public function getFormattedHalfDayHours(): ?string
    {
        ...
        $fromTime = Carbon::createFromTime($fromHour, $fromMin)->format('H:i');
        $toTime = Carbon::createFromTime($toHour, $toMin)->format('H:i');
    ...
    protected function duration(): Attribute
    {
        return Attribute::make(
            get: fn () => CarbonInterval::days((float) ($this->duration_days ?? 0))
        );
    }
    ...
    public static function formatDurationText(float $durationDays): string
    {
        ...
        return CarbonInterval::days((int) $durationDays)->cascade()->forHumans(['parts' => 2]);
    }
