...
/**
 * Notification sent to admins when a user is demoted from admin.
 *
 ...
 */
class AdminDemotionNotification extends Notification implements ShouldQueue
{
    ...
    {
        return NotificationType::AdminDemotion;
    }
