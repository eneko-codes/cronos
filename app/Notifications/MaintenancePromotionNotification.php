...
/**
 * Notification sent to admins when a user is promoted to maintenance.
 *
 ...
 */
class MaintenancePromotionNotification extends Notification implements ShouldQueue
{
    ...
    {
        return NotificationType::MaintenancePromotion;
    }
     ...
     * @return SlackMessage The Slack message instance
     */
