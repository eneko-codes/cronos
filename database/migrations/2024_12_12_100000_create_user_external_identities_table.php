...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('user_external_identities', function (Blueprint $table): void {
            $table->comment('Maps local users to their identities on external platforms for sync purposes.');
            $table->id();
            ...
            $table->string('external_email')->nullable()->comment('Email used on the external platform for sync matching');
            ...
            // Index for email lookups during sync
