...
<div
  {{ $attributes->merge(["class" => "inline-flex w-fit gap-1 whitespace-nowrap rounded-lg border border-gray-200 bg-gray-100 p-1 text-xs font-semibold dark:border-gray-700 dark:bg-gray-800 " . $class]) }}
>
