                ...
                <div class="flex items-center gap-2">
                  @if (isset($day['leave']['status']) && $day['leave']['status'] === 'validate')
                    ...
                    <x-tooltip>
                            ...
                            @if (isset($day['leave']['isHalfDay']) && $day['leave']['isHalfDay'])
                              ...
                              >
                                @if ($day['leave']['timePeriod'] === 'morning')
                                  Morning half-day
                                @elseif ($day['leave']['timePeriod'] === 'afternoon')
                                  Afternoon half-day
                                @else
                                    Half-day leave
                                @endif
                              </div>
                              @if (isset($day['leave']['halfDayTime']) && $day['leave']['halfDayTime'] !== '—')
                                <div
                                  class="text-xs text-gray-500 dark:text-gray-400"
                                >
                            ...
                            @elseif (isset($day['leave']['durationDays']) && $day['leave']['durationDays'] >= 1)
                              ...
                              >
                                @if ($day['leave']['durationDays'] == 1)
                                  Full day leave
                                @else
                                  {{ $day['leave']['durationText'] }}
                                  ({{ $day['leave']['duration'] }} today)
                                @endif
                              </div>
                            @else
                              {{-- Partial Hour Leave --}}
                              ...
                              @if (isset($day['leave']['durationDays']) && $day['leave']['durationDays'] < 1 && isset($day['leave']['timeRange']) && $day['leave']['timeRange'] && $day['leave']['timeRange'] !== '00:00 - 00:00')
                                <div
                                  class="text-xs text-gray-500 dark:text-gray-400"
                                >
                                  {{ $day['leave']['timeRange'] }}
                      ...
                      <span class="{{ $futureTextClass }}">
                        {{ isset($day['leave']['duration']) && $day['leave']['duration'] !== '0h 0m' ? $day['leave']['duration'] : '' }}
                      </span>
                    </x-tooltip>
                    <x-badge variant="info" size="sm">
                      {{ $day['leave']['leaveType'] ?? 'Leave' }}
