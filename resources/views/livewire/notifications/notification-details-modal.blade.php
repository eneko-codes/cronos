  ...
  @if ($isOpen)
    ...
    >
      <div
        ...
        wire:click.stop
        class="relative z-[101] flex max-h-[90vh] w-full max-w-lg flex-col overflow-hidden rounded-lg border-2 border-gray-200 bg-white shadow-lg transition-transform duration-300 dark:border-gray-800 dark:bg-gray-900"
      >
        {{-- Sticky Header --}}
        <div
