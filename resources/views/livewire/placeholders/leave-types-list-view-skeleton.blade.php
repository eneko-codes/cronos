<div class="flex animate-pulse flex-col gap-4">
  ...
  <!-- Leave Types List Container Placeholder -->
  <div
  ...
  >
    @for ($i = 0; $i < 20; $i++)
      ...
      >
        ...
        >
          <!-- Leave Type Info Placeholder -->
          <div class="flex flex-1 flex-col gap-1">
            <div
              class="mb-1 h-4 w-32 rounded bg-gray-300 dark:bg-gray-600"
            ></div>
          ...
          <div class="mt-2 flex flex-none flex-wrap items-center gap-2 md:mt-0">
            <div class="h-5 w-16 rounded bg-gray-200 dark:bg-gray-700"></div>
            <div class="h-5 w-16 rounded bg-gray-200 dark:bg-gray-700"></div>
            <div class="h-5 w-20 rounded bg-gray-200 dark:bg-gray-700"></div>
            <div class="h-5 w-16 rounded bg-gray-200 dark:bg-gray-700"></div>
          </div>
        </div>
      </div>
