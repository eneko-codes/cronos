<div class="flex flex-col gap-6">
  ...
  <div class="flex flex-col gap-3">
    <div
      ...
      class="flex cursor-pointer items-center justify-between border-b pb-1 dark:border-gray-600"
    >
                ...
                @isset($this->taskTimeEntries[$task->proofhub_task_id])
                  @forelse ($this->taskTimeEntries[$task->proofhub_task_id] as $entry)
                    <div
                      ...
                      class="mb-1 rounded-md border border-gray-300 bg-white p-2 text-xs last:mb-0 dark:border-gray-500 dark:bg-gray-700"
                    >
  ...
  <div class="flex flex-col gap-3">
    ...
    >
      <h2 class="text-lg font-medium text-gray-800 dark:text-gray-200">
        Project Time Entries ({{ $projectTimeEntries->count() }})
      </h2>
      <svg
      ...
      <div class="flex flex-col gap-2 pt-2">
        @forelse ($projectTimeEntries as $entry)
          <div
            ...
            class="rounded-md border border-gray-300 bg-white p-2 dark:border-gray-500 dark:bg-gray-700"
          >
