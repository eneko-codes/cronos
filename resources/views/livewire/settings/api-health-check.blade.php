<div
  class="flex h-full flex-col gap-4 rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800"
>
  ...
  <div class="space-y-2">
    <x-button
      ...
      class="w-full"
    >
      <span wire:loading.remove wire:target="pingOdoo">Ping Odoo</span>
      <span wire:loading wire:target="pingOdoo" class="flex items-center gap-1">
        <x-spinner size="4" />
      </span>
    </x-button>
    ...
    <x-button
      ...
      class="w-full"
    >
      <span wire:loading.remove wire:target="pingDesktime">Ping Desktime</span>
      <span
        wire:loading
        wire:target="pingDesktime"
    ...
    <x-button
      ...
      class="w-full"
    >
      <span wire:loading.remove wire:target="pingProofhub">Ping ProofHub</span>
      <span
        wire:loading
        wire:target="pingProofhub"
        class="flex items-center gap-1"
    ...
    <x-button
      ...
      class="w-full"
    >
      <span wire:loading.remove wire:target="pingSystemPin">
        Ping SystemPin
      </span>
      <span
        wire:loading
