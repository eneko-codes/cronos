...
>
  <div class="flex flex-col items-start gap-1 text-lg font-bold">
    ...
    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">
      Control system-wide notification settings. Admins can choose the delivery
      channel (Email, Slack, or In App Only) for all notifications except login
      flow notifications.
    </p>
  </div>
        ...
        >
          ...
          <x-tooltip>
            <x-slot name="text">
              ...
              flow notifications which always use email). Choose "In App Only"
              to store notifications without sending external alerts. This
              setting applies globally to all users.
            </x-slot>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
