          ...
          <div class="space-y-3">
            ...
            <div class="flex gap-2">
              <x-button
                ...
                variant="primary"
              >
                <x-spinner size="4" wire:loading wire:target="saveLink" />
            ...
            <div class="flex items-center gap-3">
              ...
              <div
                @class([
                  ...
                  'bg-green-100 dark:bg-green-800' => $link['isConnected'],
                  'bg-blue-100 dark:bg-blue-800' => $link['isManualLink'],
              ...
              >
                @if ($link['isConnected'])
                  ...
                  <svg
                    ...
                    viewBox="0 0 16 16"
                    fill="currentColor"
                    class="size-4 text-green-600 dark:text-green-300"
                  >
                    <path
                ...
                @elseif ($link['isManualLink'])
                  {{-- Manual link: Hand icon --}}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
                    fill="currentColor"
                    class="size-4 text-blue-600 dark:text-blue-300"
                  >
                    <path
                      d="M11 4a1 1 0 1 0-2 0v4a1 1 0 0 0 2 0V4ZM8 3a1 1 0 0 0-1 1v5a1 1 0 1 0 2 0V4a1 1 0 0 0-1-1ZM5 4a1 1 0 1 0-2 0v4a1 1 0 1 0 2 0V4ZM14 5a1 1 0 1 0-2 0v4a1 1 0 1 0 2 0V5ZM3 10.5a2.5 2.5 0 0 0 2.5 2.5h5a2.5 2.5 0 0 0 2.5-2.5V9a1 1 0 1 0-2 0v1.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5V9a1 1 0 1 0-2 0v1.5Z"
                    />
                  </svg>
                @else
                  {{-- Not connected: X icon --}}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
                    fill="currentColor"
