  ...
  @foreach ($toasts as $toast)
    @php
      ...
      $variantClass = match ($toast['variant']) {
        'success' => 'border-green-500 bg-green-50 text-green-800 dark:border-green-600 dark:bg-green-900/50 dark:text-green-200',
        'error' => 'border-red-500 bg-red-50 text-red-800 dark:border-red-600 dark:bg-red-900/50 dark:text-red-200',
        'warning' => 'border-yellow-500 bg-yellow-50 text-yellow-800 dark:border-yellow-600 dark:bg-yellow-900/50 dark:text-yellow-200',
        'info' => 'border-blue-500 bg-blue-50 text-blue-800 dark:border-blue-600 dark:bg-blue-900/50 dark:text-blue-200',
        default => 'border-gray-500 bg-gray-50 text-gray-800 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200',
      };
    @endphp
