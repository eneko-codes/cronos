  ...
  @if ($isOpen)
    ...
    >
      <div
        ...
        wire:click.stop
        class="relative z-50 mx-4 my-8 flex max-h-[90vh] w-full max-w-lg flex-col overflow-hidden rounded-lg border-2 border-gray-200 bg-white shadow-lg transition-transform duration-300 md:max-w-2xl lg:max-w-3xl dark:border-gray-800 dark:bg-gray-900"
      >
        {{-- Header --}}
        <div
          class="sticky top-0 z-20 flex items-start justify-between gap-2 border-b border-gray-200 bg-white px-4 py-3 backdrop-blur dark:border-gray-700 dark:bg-gray-900"
        >
        ...
        <div
          class="flex flex-1 flex-col gap-8 overflow-x-auto overflow-y-auto p-4 md:p-6"
        ...
        >
          ...
          <section class="flex flex-col gap-2">
            <h3
              class="flex items-center gap-2 text-sm font-semibold tracking-wide text-gray-600 uppercase dark:text-gray-400"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
          ...
          {{-- Primary Email Section (Admin and Maintenance) --}}
          @if (auth()->user()?->isAdmin() ||auth()->user()?->isMaintenance())
            ...
            {{-- Notification Preferences Section (Admin and Maintenance) --}}
            <section class="flex flex-col gap-2">
              <h3
                class="flex items-center gap-2 text-sm font-semibold tracking-wide text-gray-600 uppercase dark:text-gray-400"
              >
            ...
            {{-- Platform Sync Links Section (Admin and Maintenance) --}}
            <section class="flex flex-col gap-2">
              <h3
                class="flex items-center gap-2 text-sm font-semibold tracking-wide text-gray-600 uppercase dark:text-gray-400"
              >
